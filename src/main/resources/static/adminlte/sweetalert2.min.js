!function(e, t) {
    ...
    const Se = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
      ...
      , Ie = {}
      , He = (Ie.text = Ie.email = Ie.password = Ie.number = Ie.tel = Ie.url = (e,t)=>("string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : A(t.inputValue) || a('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')),
    Me(e, e, t),
    je(e, t),
    e.type = t.input,
    e),
    Ie.file = (e,t)=>(Me(e, e, t),
    je(e, t),
    e),
    Ie.range = (e,t)=>{
    ...
    const mt = ()=>{
      ...
      , St = (e,t)=>{
        ...
        if (n.inputValidator) {
            ...
            e.getInput().checkValidity() ? ("deny" === t ? Lt : Mt)(e, o) : (e.enableButtons(),
      ...
      , Wt = (e,n,o)=>{
        ...
        if (i)
            ...
            "Enter" === n.key)
                ...
                a = n,
                t = i,
                w(t.allowEnterKey) && !a.isComposing && a.target && e.getInput() && a.target.outerHTML === e.getInput().outerHTML && (["textarea", "file"].includes(t.input) || (Nt(),
                a.preventDefault()));
            else if ("Tab" !== n.key) {
    ...
    e = Object.freeze({
        ...
        bindClickHandler: function() {
            ...
            Jt[e] = this,
            Zt || (document.body.addEventListener("click", Xt),
            Zt = !0)
        }
    });
    function $t() {
    ...
    function en(e) {
        ...
        this.isAwaitingPromise() ? e.isDismissed || (tn(this),
        t(e)) : n && t(e)
    }
    const tn = e=>{
    ...
    const sn = e=>{
        e.isAwaitingPromise() ? (cn(b, e),
        b.awaitingPromise.set(e, !0)) : (cn(Gt, e),
        cn(b, e))
    }
      , cn = (e,t)=>{
        for (const n in e)
    ...
    var ln = Object.freeze({
        ...
        _destroy: function() {
            ...
            delete f.currentInstance) : sn(this)
        }
    });
    let un;
    class dn {
    ...
    const pn = (l,u,d)=>new Promise((e,t)=>{
        ...
        t = u,
        a = n,
        b.innerParams.get(e).toast ? Dt(e, t, a) : (Ht(t),
        qt(t),
        Vt(e, t, a)),
        o = l,
        e = f,
        ...
        t.toast || (e.keydownHandler = e=>Wt(o, e, i),
    ...
    !0)
      ...
      , vn = (Object.assign(dn.prototype, ln),
    Object.assign(dn, e),
